...
legend_list = [ 'FedAVG', 'SCAFFOLD', 'FedProx', 'ResSGD', 'ResAVG (Opt I)', 'ResAVG (Opt II)', 'ResNaive', 'Local']
...
for i in range(len(scheme_list)):
      s = scheme_list[i]
      data_X = np.array(range(60))
      data_Y = ema(M[i,0:60], 0.3)
